...
get_consort = function(df, ga_type) {
  ...
  elig = (elig_enroll$anc1ga_anc <= 24 & elig_enroll$number_anc >= 2 & 
            elig_enroll$date_del<= "2019-03-31" & 
  ...
  out_elig_outcome = data.frame(rbind(valid_recorded_ga_del, valid_ga_lmp_del, elig_mother_baby_pair, delivered_before_march_31, is_ltfu))
